  ...
  <view class="template-login">
    ...
    <view class="login">
      ...
      <view class="login__bg login__bg--top">
        <image class="bg" src="http://imagesoss.hunji.xyz/tuniao/login/1/login_top2.jpg" mode="widthFix"></image>
      </view>
      <view class="login__bg login__bg--top">
        <image class="rocket rocket-sussuspension" src="http://imagesoss.hunji.xyz/tuniao/login/1/login_top3.png" mode="widthFix"></image>
      </view>
...
<!--          <block v-if="currentModeIndex === 1">
      ...
      <view class="login__bg login__bg--bottom">
        <image src="http://imagesoss.hunji.xyz/tuniao/login/1/login_bottom_bg.jpg" mode="widthFix"></image>
      </view>
    </view>
...
<script>
  ...
  import { userLogin } from '@/utils/api/user.js'
  export default {
    name: 'login-demo-1',
      ...
      &__item {
        &--icon {
          ...
          &::after {
            ...
            background-image: url(http://imagesoss.hunji.xyz/tuniao/cool_bg_image/icon_bg5.png);
          }
        }
      }
    }
